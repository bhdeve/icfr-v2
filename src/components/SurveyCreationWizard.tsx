    ...
    <div className="min-h-screen bg-gray-50 p-6" dir="rtl">
      <div className="max-w-4xl mx-auto">
        ...
        <Dialog open={showAddDomainDialog} onOpenChange={setShowAddDomainDialog}>
          <DialogContent className="max-w-full sm:max-w-md mx-4" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>
                قم بإضافة مجال جديد لتصنيف أسئلة الاستبيان
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
        ...
        <Dialog open={showAddFilterDialog} onOpenChange={setShowAddFilterDialog}>
          <DialogContent className="max-w-full sm:max-w-md mx-4" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>
                قم بإضافة فلتر جديد لتصنيف المستفيدين وفرزهم
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
        ...
        <Dialog open={showAddQuestionDialog} onOpenChange={setShowAddQuestionDialog}>
          <DialogContent className="max-w-full sm:max-w-lg mx-4" dir="rtl">
            <DialogHeader>
              <DialogTitle>إضافة سؤال جديد</DialogTitle>
              <DialogDescription>
                قم بإنشاء سؤال جديد وإضافته إلى الاستبيان
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
        ...
        <Dialog open={showAddBeneficiaryDialog} onOpenChange={setShowAddBeneficiaryDialog}>
          <DialogContent className="max-w-full sm:max-w-md mx-4" dir="rtl">
            <DialogHeader>
              ...
              <DialogDescription>
                قم بإضافة مستفيد جديد إلى قائمة المستفيدين
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div>
