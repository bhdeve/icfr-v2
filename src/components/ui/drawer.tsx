    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=right]:w-full data-[vaul-drawer-direction=right]:border-l",
          "data-[vaul-drawer-direction=right]:sm:max-w-lg data-[vaul-drawer-direction=right]:md:max-w-2xl data-[vaul-drawer-direction=right]:lg:max-w-3xl",
          // Left drawer (RTL-friendly)
          ...
          "data-[vaul-drawer-direction=left]:sm:max-w-lg data-[vaul-drawer-direction=left]:md:max-w-2xl data-[vaul-drawer-direction=left]:lg:max-w-3xl",
          className,
        )}
        {...props}
      >
